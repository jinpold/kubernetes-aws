...
import { BoardNameHandler, BoardTypeHandler, getBoardById } from "@/app/components/board/service/board-slice";
...
export default function BoardDetailPage (props:any){
    ...
    <span>게시판이름 : </span><input type="text" placeholder={board.boardName} name="BoardName" onChange={handleClickBN} /><br /><br />
    <span>게시판타입 : </span><input type="text" placeholder={board.boardType} name="BoardType" onChange={handleClickBT} /><br /><br />
