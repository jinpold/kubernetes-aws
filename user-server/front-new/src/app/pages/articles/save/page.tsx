...
const WriterArticlePage:NextPage = () => {
  ...
  useEffect(()=>{
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg mx-auto">
      ...
      <div className="editor mx-auto w-full flex flex-col text-gray-800 border border-gray-300 p-6 shadow-lg max-w-3xl mb-8">
        {MyTypography('', '1.5rem')}
        <input
          type="hidden"
        ...
        <input
          ...
          className="title bg-gray-100 border border-gray-300 p-3 mb-4 outline-none text-lg"
          placeholder="Title"
          type="text"
          name="title"
        />
        <textarea
          ...
          className="content bg-gray-100 sec p-4 h-80 border border-gray-300 outline-none text-lg"
        ...
        <div className="buttons flex mt-4">
          <div
            className="btn overflow-hidden relative w-30 bg-white text-blue-950 p-3 px-4 rounded-xl font-bold uppercase before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-pink-400 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-200 hover:before:animate-ping transition-all duration-300"
            onClick={cancelHandler}
          >
            Cancel
          </div>
          <div className="btn overflow-hidden relative w-30 bg-white text-blue-950 p-3 px-4 rounded-xl font-bold uppercase before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-pink-400 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-200 hover:before:animate-ping transition-all duration-300">
